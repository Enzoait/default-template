...
class GenericManagementPage extends Component {
	...
	getSuperAdministratorMenu(){
		const adminMenuconfig = [
			...
			{name:"Templates de mail", key:"emailTemplates", comp: this.mailTemplates(), visible: true, className:'fa-envelope', breadItems:[{href:'#/admin?tab=platform&v=emt&u=va', title:'Email templates'}], menuGroup: 'platform'},
			...
			{name:"Utilisateurs", key:"members", comp: this.members(), visible: true, className:'fa-group', breadItems:[{href:'#', title:'Membres'}], menuGroup: 'platform'},
	...
	getHiddenMenu(){
		const hiddenMenuConfig = [
			{name:"Utilisateurs", key:"members", comp: this.members(), visible: true, className:'fa-users', breadItems:[{href:'#/admin?tab=platform&v=emailTemplates&u=va', title:'Members'}]},
