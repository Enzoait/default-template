...
@RestController
@RequestMapping("/api/secured/v1/katappult/cloud/generated/pointer")
public class PointerServiceFacade {
  ...
  public Serializable create(@RequestBody String request) {
    ...
    uiAttributes.from(request, Pointer.class);
  ...
  public Serializable details(@RequestParam(name = "entityId") final RestObjectFullId entityId,
    ...
    IOperationResult result = new SingleResult();
    Pointer entity = (Pointer) entityId.getPersistable();
